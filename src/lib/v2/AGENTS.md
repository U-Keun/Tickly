...
- Cloud sync is deferred. v2 stores should not schedule cloud sync unless a future task explicitly reintroduces sync.
...
- Do not import v1 sync, cloud auth, widget stores, account, or v1 tag stores here.
