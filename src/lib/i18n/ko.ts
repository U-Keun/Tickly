export const ko = {
  ...
  v2TagManageTitle: '태그 관리',
  v2TagManageGroupTitle: 'v2 태그',
  v2TagManageDescription:
    '태그 이름을 정리하거나 사용하지 않는 태그를 제거할 수 있습니다. 태그를 삭제해도 항목은 삭제되지 않습니다.',
  v2TagManageEmptyTitle: '아직 태그가 없습니다.',
  v2TagManageEmptyDescription: '항목에 태그를 추가하면 여기에서 관리할 수 있습니다.',
  v2TagItemCountTemplate: (count: number) =>
    count === 0 ? '연결된 항목 없음' : `${count}개 항목`,
  v2RenameTag: '태그 이름 수정',
  v2RenameTagTitle: '태그 이름 수정',
  v2RenamingTag: '수정 중...',
  v2SaveTag: '저장',
  v2TagNameLabel: '태그 이름',
  v2TagNamePlaceholder: '태그 이름',
  v2DeleteTag: '태그 삭제',
  v2DeletingTag: '삭제 중...',
  v2DeleteTagConfirmTitle: '태그를 삭제할까요?',
