export const ko = {
  ...
  v2ManageCategory: '카테고리 관리',
  v2CreateCategoryTitle: '카테고리 추가',
  ...
  v2DeleteCategoryConfirmAction: '삭제',
  v2DeletingCategory: '삭제 중...',
  v2MoveLeft: '왼쪽',
  v2MoveRight: '오른쪽',
  v2EditCategoryOrder: '순서 편집',
  v2FinishCategoryOrder: '완료',
  v2CategoryOrderHint: '카테고리를 드래그해서 순서를 바꿔보세요.',
  v2Items: '항목',
  ...
  v2EditItem: '항목 수정',
  v2EditItemDetails: '항목 상세 수정',
  v2ItemTextLabel: '항목 이름',
  v2ItemTextPlaceholder: '항목 이름을 입력하세요',
  v2ItemMemoLabel: '메모',
  v2ItemMemoPlaceholder: '메모를 입력하세요',
  ...
  v2CreateTagSuggestionTemplate: (name: string) => `#${name} 태그 추가`,
  v2NoTagsYet: '아직 태그가 없습니다.',
  v2NoTagSuggestionsTemplate: (query: string) => `"${query}"와 일치하는 태그가 없습니다.`,
  v2RemoveTagTemplate: (name: string) => `${name} 태그 제거`,
  v2TagSearchSnippetTemplate: (tag: string) => `태그: ${tag}`,
  v2SaveItem: '저장',
  v2DeleteItem: '항목 삭제',
  v2DeleteItemConfirmTitle: '항목을 삭제할까요?',
