...
import type { StreakHeatmap, Tag } from '../../types';
import StreakOverlay from './StreakOverlay.svelte';

const now = '2026-06-17T00:00:00Z';
const tags: Tag[] = [{ id: 1, name: 'health', created_at: now, updated_at: now }];
...
const meta = {
  title: 'Checklist/StreakOverlay',
  component: StreakOverlay,
  tags: ['autodocs'],
  args: {
    show: true,
    heatmaps,
...
} satisfies Meta<typeof StreakOverlay>;
