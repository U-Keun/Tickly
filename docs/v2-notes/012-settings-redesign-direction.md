...
The v2 settings entry screen uses its own v2 shell while preserving the rebuilt local settings routes. This keeps the main app flow visually aligned with v2 without forcing a broad rewrite of every historical settings file at once.
...
flowchart TD
  ...
  Settings --> Data["v2 data: tags, archive"]
