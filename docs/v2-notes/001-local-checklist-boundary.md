...
Search, tags, local repeat rules, and local reminder times are now part of v2. Streaks, linked apps, graph view, widgets, Supabase sync, and data migration remain intentionally excluded.
