...
- Search matches item name, memo, and tag names. Local repeat rules are shown in item detail surfaces but are not part of search; reminders, linked apps, and sync metadata remain out of scope.
